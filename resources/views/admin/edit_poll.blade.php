    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                ...
                <form id="form-horizontal" class="form-horizontal form-wizard-wrapper" action="{{route('poll.update',$poll->id)}}" method="post">
                    @csrf
                    @method('patch')
                    <h3>Poll Details</h3>
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="candidates" class="form-control" id="candidates" placeholder="E.g Daniel,Timothy,John " cols="30" rows="10">{{$poll->candidates}}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col col-md-12">
                                <div class="form-group">
                                    ...
                                    <p style="color: red">If more than one seperate with a coma " , "</p>
                                    <textarea name="allowedvoters" class="form-control" id="voters" placeholder="E.g DanielTimothy01@gmail.com, TimBaron@yahoo.com" cols="30" rows="10">{{$poll->allowedvoters}}</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <fieldset>
                        <div class="p-3">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="customCheck1" name="tc" value="{{$poll->TC}}">
